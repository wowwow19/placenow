		...
		<div class="container">
			<div class="row">
				<div class="header-text col-xl-9 mr-auto mb-5">
		        	<h1 class="badge badge-light">장소추가</h1>
		    	</div>
			</div>
		</div>
	</header>
	...
	<div class="place-add-wrapper">
		<form class="place-add-form needs-validated card shadow" method="post" >
			...
			<div class="row input-pname mb-3">
				<input type="text" name="pname" class="form-control" id="pname" placeholder="장소명" required>
			</div>
			<div class="row input-address input-group mb-3">
			  <input type="text" name="address" class="form-control" id="sample4_roadAddress" placeholder="주소" required>
